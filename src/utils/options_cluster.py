...
def args_parser():
    ...
    # federation
    parser.add_argument('--alpha', type=float, default=1,help="parameter of calculate weight of federation")
    parser.add_argument('--bound', type=float, default=1, help="parameter of compress bound")
    parser.add_argument('--badnum', type=float, default=0, help="num of bad user")
    parser.add_argument('--badrange', type=float, default=0.01, help="range of bad model")
    parser.add_argument('--flipnum', type=float, default=0, help="number of label flipped users")
    parser.add_argument('--backdoorfrac', type=float, default=0, help="number of label flipped users")
    # parser.add_argument('--backdoorfrac', type=float, default=0, help="number of label flipped users")
    parser.add_argument('--times', type=int, default=1, help="times")
    parser.add_argument('--noise2', type=float, default=0, help="my noise")
    parser.add_argument('--sigma', type=float, default=1, help="similarity weight")
