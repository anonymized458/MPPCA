...
from src.similarity_method import *
...
for time in range(args.times):
    ...
    for iteration in range(args.rounds):
        ...
        # print(w_locals2)
        # 传入模型参数
        # fed_avg_freqs = cal_freq_by_l2(w_local_delta, args.alpha)
        # fed_avg_freqs = cal_freq_by_kl(w_local_delta, args.lr, args.alpha)
        # 传入模型参数更新
        fed_avg_freqs = cal_freq_by_cos(w_local_delta, args.alpha)
